package com.jvbo.framework.utils.os;
...
public class ToolOS {
	...
	public static final String java_ext_dirs = "java.ext.dirs"; // �?��或多个扩展目录的路径
	public static final String os_name = "os.name"; // 操作系统的名�?
	public static final String os_arch = "os.arch"; // 操作系统的构�?
	public static final String os_version = "os.version"; // 操作系统的版�?
	public static final String file_separator = "file.separator"; // 文件分隔�?
	public static final String path_separator = "path.separator"; // 路径分隔�?
	public static final String line_separator = "line.separator"; // 行分隔符
	public static final String user_name = "user.name"; // 用户的账户名�?
    public static final String user_home = "user.home"; // 用户的主目录
    public static final String user_dir = "user.dir"; //  用户的当前工作目�?
