package site.jvbo.fun.okex.dao.runner;
...
public class Generator {
	...
	// 根据命名规范，只修改此常量值即可
	private static String MODULE = "jvbo-fun-okex";
	private static String DATABASE = "jvbo_fun_okex";
	private static String TABLE_PREFIX = "okex_";
	private static String PACKAGE_NAME = "site.jvbo.fun.okex";
