...
public enum ResponseCodeEnum implements IEnum {
    ...
    ResponseCodeEnum(String code, String name, String flag) {
        this.code = code;
        this.name = name;
		this.flag = flag;
    }
	...
	public static ResponseCodeEnum valueOf(int statusCode) {
		for (ResponseCodeEnum status : values()) {
			if (status.getCodeInt() == statusCode) {
				return status;
			}
		}
	...
	public static enum Series {
		...
		public static Series valueOf(ResponseCodeEnum status) {
			return valueOf(status.getCodeInt());
		}
