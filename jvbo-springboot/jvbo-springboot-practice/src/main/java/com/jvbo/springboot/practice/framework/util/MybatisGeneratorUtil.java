package com.jvbo.springboot.practice.framework.util;
...
public class MybatisGeneratorUtil {
    ...
    public static void generator(
		...
		String generatorConfig_xml = MybatisGeneratorUtil.class.getResource("/").getPath().replace("/target/test-classes/", "") + "/src/main/resources/generator-config.xml";
		...
		try {
			...
			context.put("generator_javaModelGenerator_targetPackage", package_name + ".core.model");
			context.put("generator_sqlMapGenerator_targetPackage", mapper_xml);
			context.put("generator_javaClientGenerator_targetPackage", package_name + ".core.dao");
		...
		String servicePath = basePath + "/src/main/java/" + package_name.replaceAll("\\.", "/") + "/core/service";
		String serviceImplPath = basePath + "/src/main/java/" + package_name.replaceAll("\\.", "/") + "/core/service/impl";
